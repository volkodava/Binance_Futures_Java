...
public interface SubscriptionClient {
    ...
    /**
     * Subscribe trade event. If the aggregate trade is updated, server will send the data to client and onReceive in
    ...
    /**
     * Subscribe aggregate trade event. If the aggregate trade is updated, server will send the data to client and
    ...
    (SubscriptionListener<List<SymbolMiniTickerEvent>> callback, SubscriptionErrorHandler errorHandler);
